...
class TripLocationVerificationState(Base):
    __tablename__ = (
    ...
    last_distance_to_pickup_m: Mapped[
        Decimal | None
    ] = mapped_column(
        Numeric(12, 2),
        nullable=True,
    ...
    progress_anchor_distance_to_pickup_m: Mapped[
        Decimal | None
    ] = mapped_column(
        Numeric(12, 2),
        nullable=True,
    ...
    progress_anchor_horizontal_accuracy_m: Mapped[
        Decimal | None
    ] = mapped_column(
        Numeric(8, 2),
        nullable=True,
    ...
    progress_anchor_captured_at: Mapped[
        datetime | None
    ] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
    ...
    arrival_candidate_count: Mapped[
        int
    ] = mapped_column(
        Integer,
        default=0,
